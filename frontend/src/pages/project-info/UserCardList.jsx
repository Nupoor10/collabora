...
function genUserDetail() {
  ...
  let userwindow = {};
  userwindow.name = faker.person.fullName();
  userwindow.about = bio[Math.floor(Math.random()*bio.length)];
  userwindow.image = faker.image.avatar();
  return userwindow;
}
